...
case "$ACTION" in
    ...
    "record")
        ...
        echo "Recording call graphs at max sample rate. Use 'perf report' afterward to inspect."
    ...
    *)
        ...
        echo "  annotate: Record cycles without dwarf (fast) and open instruction view"
        exit 1
        ;;
esac
